...
<p class="pager">
	<?php if ($previous_page !== FALSE): ?>
		<b><a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev">&lt;</a></b>
	<?php else: ?>
		<b>&lt;</b>
	<?php endif ?>
	...
	<?php foreach ($links as $number => $content): ?>
		...
		<?php elseif (($use_n6 AND $number == $n6) OR ($use_n3 AND $number == $n3)): ?>
			<span class="empty"><?php echo $content ?></span>
		<?php else: ?>
	...
	<?php if ($next_page !== FALSE): ?>
		<b><a href="<?php echo HTML::chars($page->url($next_page)) ?>" rel="next">&gt;</a></b>
	<?php else: ?>
		<b>&gt;</b>
	<?php endif ?>
</p><!-- .pagination -->