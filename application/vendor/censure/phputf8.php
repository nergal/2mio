 ...
 * Example:
 *   $s = 'Hello, Привет';
 *   if (PHPUTF8::is_utf8($s)) echo PHPUTF8::strlen($s);
 *
...
class PHPUTF8
{
	 ...
	 *   PHPUTF8::blocks_check('поисковые системы Google и Yandex', array('Basic Latin', 'Cyrillic'));
	 *   #You can check the named, direct ranges or codepoints together:
	 *   PHPUTF8::blocks_check('поисковые системы Google и Yandex', array(array(0x20, 0x7E),     #[\x20-\x7E]
	...
	public static function preg_quote_case_insensitive($s, $delimiter = null)
	{
		...
		$s_re = '';
		$s_lc = PHPUTF8::lowercase($s); if ($s_lc === false) return false;
		$s_uc = PHPUTF8::uppercase($s); if ($s_uc === false) return false;

		$chars_lc = PHPUTF8::str_split($s_lc); if ($chars_lc === false) return false;
		$chars_uc = PHPUTF8::str_split($s_uc); if ($chars_uc === false) return false;
