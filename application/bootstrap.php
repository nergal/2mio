...
if (Kohana::$environment === Kohana::DEVELOPMENT) {
	$config = array(
		...
		'errors'    => TRUE,
		'charset'   => 'utf-8',
		'modules'   => 'apis/twitter, asset, auth, cache, beanstalk, blocks, database, demo, event, image, mailer, meta, oauth, orm, orm-mptt, pagination, plater, resizer, unittest, sso, libs, jelly, jelly-auth, service',
	...
	$config = array(
		...
		'errors'    => FALSE,
		'charset'   => 'utf-8',
		'modules'   => 'apis/twitter, asset, auth, cache, beanstalk, blocks, database, demo, event, image, mailer, meta, oauth, orm, orm-mptt, pagination, plater, resizer, sso, libs, service',
		'cache_dir' => APPPATH.'cache',
		'logdir'    => FALSE,
	...
	$config = array(
		...
		'errors'    => FALSE,
		'charset'   => 'utf-8',
		'modules'   => 'apis/twitter, asset, auth, cache, beanstalk, blocks, database, event, image, mailer, meta, oauth, orm, orm-mptt, pagination, plater, resizer, sso, libs, service',
		'cache_dir' => APPPATH.'cache',
		'logdir'    => APPPATH.'../etc/logs/application',
