...
if (Kohana::$environment === Kohana::DEVELOPMENT) {
	$config = array(
		...
		'errors'    => TRUE,
		'charset'   => 'utf-8',
		'modules'   => 'apis/twitter, asset, auth, cache, beanstalk, database, demo, event, image, mailer, oauth, orm, orm-mptt, pagination, plater, resizer, unittest, sso, libs, jelly, jelly-auth',
	...
	$config = array(
		...
		'errors'    => FALSE,
		'charset'   => 'utf-8',
		'modules'   => 'apis/twitter, asset, auth, cache, beanstalk, database, event, image, mailer, oauth, orm, orm-mptt, pagination, plater, resizer, sso, libs',
		'cache_dir' => APPPATH.'cache',
		'logdir'    => APPPATH.'../etc/logs/application',
